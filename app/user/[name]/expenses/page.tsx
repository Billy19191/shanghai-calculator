          ...
          return (
            <div key={group.person} className="flex flex-col">
              <div className="flex justify-between font-bold text-lg border-b border-gray-200 pb-1 mb-3">
                ...
                <span>{personTotal.toFixed(2)} THB</span>
              </div>
  ...
  return (
    <div className="page-transition flex flex-col items-center justify-center min-h-dvh py-10 px-5 max-w-md mx-auto w-full">
      ...
      <div className="flex flex-col items-center gap-1 text-gray-500 mb-8 w-full border-b border-gray-200 pb-6">
        <p>
          Total to pay:{' '}
          <span className="font-bold text-red-500">{totalExpense.toFixed(2)} THB</span>
        </p>
        <p>
          Total owed to me:{' '}
          <span className="font-bold text-green-500">{totalOwesMe.toFixed(2)} THB</span>
        </p>
      </div>
